...
<div class="fd-right" style="margin-top: 40px;"><a
	href="${ctx}/shop/user/register.jsp">切换成个人账号注册&nbsp;&nbsp;&gt;&gt;</a>
</div>
</div>
</div>
...
<div class="form-part">
<form action="${ctx}/user/regC.do" method="post" id="form_login" name="form_login">
<table>
	<tbody>
		<tr>
		...
		<tr>
			<td class="col1"><label for="userName_per" class="uname" data-icon="p">公司名称</label></td>
			<td class="col2">
