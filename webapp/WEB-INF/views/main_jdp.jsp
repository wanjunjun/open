...
<div id="main_container">
    ...
    <div class="left_content">
            ...
            <input type="image" class="search_submit" src="${ctx}/css/jdp/images/search.png" />
            </form>            
            </div>                         
            ...
            <div class="sidebar_box">
                ...
                <h3>用户帮助</h3>
                <img src="${ctx}/css/jdp/images/info.png" alt="" title="" class="sidebar_icon_right" />
                <p>
Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
            ...
            <div class="sidebar_box">
                ...
                <div class="sidebar_box_content">
                <h4>公司公告</h4>
                <img src="${ctx}/css/jdp/images/notice.png" alt="" title="" class="sidebar_icon_right" />
                <p>
Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
                </p>                
                </div>
            ...
            <div class="sidebar_box">
                ...
                <div class="sidebar_box_content">
                <h5>相关下载</h5>
                <img src="${ctx}/css/jdp/images/photo.png" alt="" title="" class="sidebar_icon_right" />
                <p>
Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
                </p>                
                </div>
...
<table id="rounded-corner" summary="2007 Major IT Companies' Profit">
    ...
    <tbody>
    	<tr>
            ...
            <td><a href="#"><img src="${ctx}/css/jdp/images/user_edit.png" alt="" title="" border="0" /></a></td>
            <td><a href="#" class="ask"><img src="${ctx}/css/jdp/images/trash.png" alt="" title="" border="0" /></a></td>
        </tr>
