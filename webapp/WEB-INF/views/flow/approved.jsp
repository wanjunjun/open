...
<head>
		...
		var setting = {
			    ...
			    gridComplete:function(){
			    	...
			    	for(var i=0; i<ids.length; i++){
			    		var id=ids[i];
			    		var action = "<a href='#' style='color:#f60' onclick='showProcess(" + id + ")'>审批过程</a>";
			    		action += "<a href='#' style='color:#f60;margin-left:10px' onclick='showDetail(" + id + ")'>详细</a>";
	...
	function showProcess(id){
		window.location.href = "${ctx}/flowProcess/showProcess.do?id="+id;
	}
	function showDetail(id){
		window.location.href = "${ctx}/flowProcess/showFlowForm.do?oper=view&id="+id;
	}
