<?php if (!defined('THINK_PATH')) exit(); if(is_array($list)): foreach($list as $key=>$vo): ?><li>
		<div class="noUserImg"><a class="userPic" href="/wp/snsBlog/admin/personal/view.shtml?id=<?php echo ($vo["user_fan"]); ?>"><img src="/wp/snsBlog/Public/<?php echo W('Home/My/getUserVal',array($vo['user_fan'],'header_img'));?>" alt="" class="userImg" onerror="javascript:this.src='/wp/snsBlog/Public/images/user_default.png';"></a></div>
