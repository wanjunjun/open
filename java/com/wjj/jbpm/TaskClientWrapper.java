...
public class TaskClientWrapper {
	...
	public void suspend(long taskId, final String userId) {
		BlockingTaskOperationResponseHandler completeOperationResponseHandler = new BlockingTaskOperationResponseHandler();
		client.suspend(taskId, userId, completeOperationResponseHandler);
		completeOperationResponseHandler.waitTillDone(1000);
		// Wait for some time so that the process follows.
		try {
			Thread.sleep(1000);
	...
	public void stop(long taskId, final String userId) {
		BlockingTaskOperationResponseHandler completeOperationResponseHandler = new BlockingTaskOperationResponseHandler();
		client.stop(taskId, userId, completeOperationResponseHandler);
		completeOperationResponseHandler.waitTillDone(1000);
		// Wait for some time so that the process follows.
		try {
			Thread.sleep(1000);
	...
	public void fail(long taskId, final String userId,final Object result) {
		...
		BlockingTaskOperationResponseHandler failOperationResponseHandler = new BlockingTaskOperationResponseHandler();
		client.complete(taskId, userId, data, failOperationResponseHandler);
		failOperationResponseHandler.waitTillDone(1000);
