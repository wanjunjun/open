...
import com.wjj.cwz.dao.SimpleHibernateOrclDao;

@Component
@Transactional
public abstract class CommonOrclService {

	/*private static Logger logger = LoggerFactory.getLogger(CommonOrclService.class);

	@Autowired
	@Qualifier("sessionFactory_orcl")
	...
	//基础crud
	public abstract SimpleHibernateOrclDao getDao();
